...
const signedSeries = [
  {
    data: [24, 35, 47, 40, 39, 39, 55, 38, 0, 0],
  },
];
const rentalSeries = [
  {
    data: [13, 24, 35, 46, 33, 53, 60, 23, 0, 0],
  },
];
const saleSeries = [
  {
    data: [11, 23, 37, 46, 55, 60, 43, 13, 0, 0],
  },
];
const activeSeries = [
  {
    data: [12, 21, 32, 40, 55, 35, 47, 15, 0, 0],
  },
];
        ...
        <div className="flex items-center gap-2 flex-wrap ">
          <div className="flex-1">
            ...
            <span className="text-xs text-default-600">
              Demographic analytics for all listed properties
            </span>
          </div>

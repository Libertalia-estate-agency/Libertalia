            ...
            <CardContent>
              <div className="flex gap-6 flex-col md:flex-row pt-8">
                <div className="flex-1">
                  <Link href="#">
                    <Logo3 className="w-24 h-24 text-primary mb-2.5" />
                    <span className="text-3xl font-bold text-primary-600">Libertalia</span>
                  </Link>
                  <div className="mt-5">
                    <div className="text-lg font-semibold text-default-900">Billing To:</div>
                    <div className="text-lg font-medium text-default-800 mt-1">Maxwell Office Park</div>
                  ...
                  <TableBody className="[&_tr:last-child]:border-1">
                    {data.map((item, index) => (
                      <TableRow key={`invoice-description-${index}`} >
                        ...
                        <TableCell className="text-sm font-medium text-default-600 whitespace-nowrap">{item.rate}/zar</TableCell>
                        <TableCell className="ltr:text-right rtl:text-left text-sm font-medium text-default-600">R {item.amount}</TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
                </Table>
                  ...
                  <div>
                    {
                      [
                        ...
                        <div key={`invoice-item-${index}`} className="mb-3 text-end flex justify-end">
                          ...
                          <span className="text-sm font-medium text-default-600  text-end w-[100px] md:w-[160px] block">R {item.amount}</span>
                        </div>
                      ))
                    }
                  </div>
              ...
              <div className="mt-8 text-xs text-default-800">© 2024 Libertalia</div>
            </CardContent>
          </Card>

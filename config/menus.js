  ...
  sidebarNav: {
    ...
    classic: [
        ...
        child: [
          {
            ...
            href: "https://www.youtube.com/@libertaliagroup",
            target: "_blank",
            icon: Graph,
          }
        ],
      },
      {
        ...
        child: [
          {
            title: "Libertalia Listing Policy",
            href: "/pdfs/code_of_conduct.pdf",
            target: "_blank",
            icon: Graph,
          },
          {
            title: "Libertalia Terms & Conditions",
          ...
          {
            title: "Cookie Policy",
            href: "/pdfs/statement_of_commitment.pdf",
            icon: Graph,
            target: "_blank",
          ...
          {
            title: "PAIA Manual",
            href: "/pdfs/agent_agreement_template.pdf",
            icon: Graph,
            target: "_blank",
